...
@section('title', 'Organizatör · yerin.')
@section('panel-label', 'Organizatör paneli')
@section('sidebar') @include('organizer.partials.sidebar', ['current' => 'dashboard']) @endsection
@section('content')
<div class="d-flex justify-content-between align-items-start mb-4">
    <div>
        <div class="eyebrow">Organizatör paneli</div>
        <h1 class="display-title" style="font-size: 48px;">Merhaba, {{ auth()->user()->firstName() }}.</h1>
